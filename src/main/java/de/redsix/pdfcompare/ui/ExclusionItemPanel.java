...
public class ExclusionItemPanel extends JPanel {
    static public String INPUT_CHANGED = "input_changed";
    static public String GOT_FOCUS = "got_focus";
    static public String REMOVE = "remove";
    
    static private PositiveIntegerVerifier VERIFIER = new PositiveIntegerVerifier();
    static private Font LABEL_FONT = Font.decode("SansSerif-plain-10");
    static private Color INVALID_COLOR = new Color(0xd08080);
    ...
    public void setData(PageArea pageArea) {
